package com.xappteam.launcher.myfeed
...
import com.xappteam.launcher.launcherclient.LauncherClientProxyConnection
import com.xappteam.launcher.launcherclient.WindowLayoutParams
import com.xappteam.launcher.myfeed.updater.Updater
...
class ProxyImpl(val context: Context) : ILauncherClientProxy.Stub() {
    ...
    override fun init(callback: ILauncherClientProxyCallback): Int {
        allowed = "me.craftsapp.pielauncher.plah" == callingPackage || "me.craftsapp.pielauncher" == callingPackage
        enforcePermission()
